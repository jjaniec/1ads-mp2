...
#3.3[0]
def     get_appendable_in_arr(arr: Board, coords: Coord, coordstoadd: Tuple[int, int]) -> int:
...
def     get_adj_cells(n: int, arr: Board, coords: Tuple[int, int], li: List[Coord]) -> None:
...
print(arr)
remove_zeros(5, arr, tupl)print(arr)"""
